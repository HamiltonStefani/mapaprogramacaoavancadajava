 ...
 */
/*Hamilton Stefani RA: 20003803-5*/
...
public class Result extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<div class=\"container-md\">\n" +
"            <div class=\"row mb-4\">\n" +
"                <div class=\"col-10 mt-4\">");
            out.println("<h2>Você é</h2>");
            out.println("<div class=\"alert alert-info\">");
            out.println("<h1> " + this.resultado(soma) + "</h1>");
            out.println("</div>");
            out.println("<a href=\".\\\"class=\"btn btn-secondary btn-lg\">Voltar</a>");
            out.println("</div>");
            out.println("</div>");
            out.println("</div>");
            out.println("</body>");
    ...
    private String resultado(int soma){
        if(soma <= 10)
         ...
         else return "Sem Resultado";
        
    }
    
    private int calcTotal(char q1, char q2, char q3, char q4, char q5, char q6, char q7, char q8) {
    
    return this.calcQ1(q1) + this.calcQ2(q2) + this.calcQ3(q3) + this.calcQ4(q4) + this.calcQ5(q5) + this.calcQ6(q6) + this.calcQ7(q7) + this.calcQ8(q8);
}
